#!usr/bin/env python
# -*- coding: utf-8 -*-
# usage: restriction_enzymes.py [-h] -di path [-do DIR_OUT] [-sd SUB_DIR]
#                               [-ssd SUB_SUB_DIR] [-pt PATTERN_FILE]
# restriction_enzymes.py: error: the following arguments are required: -di/--dir_in
# python restriction_enzymes.py -di Data/test -do Results/Tests -pt Data/Rstriction_enzymes/RE_cut_sites
...
import argparse
import pandas as pd
from system_utils import make_me_a_folder, get_files, read_patterns
from fasta_parser import parse_fasta
from sequence_utils import all_re_cut_sites
