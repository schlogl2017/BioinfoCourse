...
# required: -p/--path
# python concatenation_df.py -p Results/splitted_genomes_merged -sd chromosomes -d Results/test
...
import numpy as np
import pandas as pd
from system_utils import make_me_a_folder, get_csv_files, get_species_name
...
def main():
    ...
    for spc in spc_names:
        filenames = find_csv_filenames(dir_name, spc, sub_dir, sub_sub_dir, num_csvs + 1, suffix)
