    ...
    for filename in filenames:
        for name, seq in fasta_parser.parse_fasta(filename):
            ...
            if opt.kmer:
                ...
                with open(f"{dir_out}/{n_name}_{opt.max_k}_kmer_counts.csv", 'w') as fout:
            ...
            if opt.pal:
                ...
                with open(f"{dir_out}/{n_name}_{opt.max_k}_palindrome_counts.csv", 'w') as fout:
            ...
            if opt.all:
                ...
                for data in kmer_data:
                    ...
                    zscr = data[3]
                    eval = data[4]
                    data_dict[kmer] = data_dict.get(kmer, []) + [obs, exp, zscr, eval]
                with open(f'{dir_out}/{outfile}_all_kmers_z_scores.csv', 'w') as fout:
